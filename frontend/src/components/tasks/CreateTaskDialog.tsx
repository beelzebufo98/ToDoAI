...
import type { Priority, ComplexityLevel } from '@/api/tasks'
...
export function CreateTaskDialog({ open, onClose }: Props) {
  ...
  const { register, handleSubmit, formState: { errors }, setValue, watch, reset } = useForm<FormData>({
    ...
    defaultValues: { priority: 5, complexityLevel: 5 },
  })
            ...
            <form onSubmit={handleSubmit(d => mutation.mutate(d))} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1.5">
                  ...
                  <Input type="number" min={1} className="h-10 bg-background/80" {...register('estimatedMinutes', { valueAsNumber: true })} />
