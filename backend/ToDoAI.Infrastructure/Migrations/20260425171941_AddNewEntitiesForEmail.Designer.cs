...
namespace ToDoAI.Infrastructure.Migrations
{
    ...
    [Migration("20260425171941_AddNewEntitiesForEmail")]
    partial class AddNewEntitiesForEmail
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ToDoAI.Domain.Entities.TaskEntity", b =>
                {
                    ...
                    b.Property<int>("ActualSpentMinutes")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("ToDoAI.Domain.Entities.TaskWorkSessionEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TaskWorkSessions", "ToDoAIService");
                });
            ...
            modelBuilder.Entity("ToDoAI.Domain.Entities.TaskExecutionEntity", b =>
                {
                    b.HasOne("ToDoAI.Domain.Entities.ScheduleEntity", "Schedule")
                        .WithMany()
            ...
            modelBuilder.Entity("ToDoAI.Domain.Entities.TaskWorkSessionEntity", b =>
                {
                    b.HasOne("ToDoAI.Domain.Entities.ScheduleEntity", "ScheduleBlock")
                        .WithMany()
                        .HasForeignKey("ScheduleBlockId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("ToDoAI.Domain.Entities.TaskEntity", "Task")
                        .WithMany("TaskWorkSessions")
                        .HasForeignKey("TaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
