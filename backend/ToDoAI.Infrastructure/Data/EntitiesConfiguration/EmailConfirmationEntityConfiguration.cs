...
public sealed class EmailConfirmationEntityConfiguration :  IEntityTypeConfiguration<EmailConfirmationEntity>
{
    public void Configure(EntityTypeBuilder<EmailConfirmationEntity> builder)
    {
        builder.ToTable("EmailConfirmations", "ToDoAIService");
